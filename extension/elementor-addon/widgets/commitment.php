...
class Clinic_Elementor_Commitment extends Widget_Base
{
	...
	{
		return esc_html__('Cam kết', 'clinic');
	}
	...
	protected function render(): void
	{
		...
		<div class="element-commitment">
			<?php if ( $settings['list'] ) : ?>
				<div class="element-commitment__warp">
