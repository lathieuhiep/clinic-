...
class Clinic_Elementor_Step_Grid extends Widget_Base
{
    ...
    {
        return esc_html__('Các bước thực hiện', 'clinic');
    }
    ...
    protected function register_controls(): void
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 3,
                'selectors' => [
                    '{{WRAPPER}} .element-step-grid__warp' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .element-step-grid__warp' => 'grid-column-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .element-step-grid__warp' => 'grid-row-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
                    '{{WRAPPER}} .element-step-grid__warp .item__body .title' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .element-step-grid__warp .item__body .title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
                    '{{WRAPPER}} .element-step-grid__warp .item__body .stt' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Typography', 'clinic' ),
                'selector' => '{{WRAPPER}} .element-step-grid__warp .item__body .stt',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
                    '{{WRAPPER}} .element-step-grid__warp .item__body .content' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Typography', 'clinic' ),
                'selector' => '{{WRAPPER}} .element-step-grid__warp .item__body .content',
            ]
        );
    ...
    protected function render(): void
    {
        ...
        ?>
        <div class="element-step-grid">
            <div class="element-step-grid__warp">
