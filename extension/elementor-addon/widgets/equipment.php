...
class Clinic_Elementor_Equipment extends Widget_Base
{
	...
	{
		return esc_html__('Trang thiết bị', 'clinic');
	}
	...
	protected function register_controls(): void
	{
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Danh sách trang thiết bị', 'clinic' ),
	...
	protected function render(): void
	{
		...
		?>
		<div class="element-equipment">
			<div class="element-equipment__warp">
