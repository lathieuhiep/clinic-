	...
	protected function render(): void {
        ...
        ?>
            <div class="element-post-grid">
                <?php
                if ( !empty( $cat_post ) ) :
                    $category = get_category($cat_post);
                    $category_name = $category->name;
                    $category_link = get_category_link($cat_post);
                ?>
                    <div class="tob-box text-center">
                        <h2 class="cate-name text-uppercase">
                        ...
                        <div class="image-box">
                            <img src="<?php echo esc_url( get_theme_file_uri('extension/elementor-addon/images/bg-title.png') ) ?>" alt="">
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="element-post-grid__warp">
					<?php while ($query->have_posts()): $query->the_post(); ?>
                        <div class="item">
                            <div class="item__post-name">
                                <h3 class="title">
                                    <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                                        <img src="<?php echo esc_url( get_theme_file_uri('extension/elementor-addon/images/hot.png') ) ?>" alt="">
