...
function clinic_register_widget_elementor_addon( $widgets_manager ): void {
    ...
    require get_parent_theme_file_path( '/extension/elementor-addon/widgets/evaluate.php' );
    require get_parent_theme_file_path( '/extension/elementor-addon/widgets/statistical.php' );
...
//    require get_parent_theme_file_path( '/extension/elementor-addon/widgets/contact-us.php' );
    ...
    $widgets_manager->register( new \Clinic_Elementor_Evaluate() );
    $widgets_manager->register( new \Clinic_Elementor_Statistical() );
