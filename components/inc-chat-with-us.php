...
<div class="chat-with-us">
	<?php if ( !empty( $chat_zalo['phone'] ) ) : ?>
        ...
        >
            <img alt="zalo" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/zalo-icon-contact.webp' ) ) ?>" width="50" height="50" />
        </a>
	<?php endif; ?>

    <?php if ( $link_messenger ) : ?>
        <a class="link chat-with-us__messenger" href="<?php echo esc_url($link_messenger); ?>" target="_blank">
            <img alt="facebook" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/mess-facebook-contact.webp' ) ) ?>" width="50" height="50" />
        </a>
    <?php endif; ?>

	<?php if ($call_phone) : ?>
        <a class="link chat-with-us__phone alo-circle-anim" href="tel:<?php echo esc_attr(clinic_preg_replace_ony_number($call_phone)); ?>">
            <img alt="phone" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/phone-icon-contact.webp' ) ) ?>" width="50" height="50" />
        </a>
	<?php endif; ?>
</div>